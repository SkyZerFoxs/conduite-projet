...
void \mbox{\hyperlink{affichage_8h_af6becf985f75737e7118d19a69ff27af}{get\+Win\+Info}} (SDL\+\_\+\+Window $\ast$window, \mbox{\hyperlink{structmap__t}{map\+\_\+t}} $\ast$map, SDL\+\_\+\+Rect $\ast$view, int $\ast$width, int $\ast$height, int $\ast$dst\+Coef, int $\ast$x\+Border, int $\ast$y\+Border)
...
\end{DoxyReturn}
\mbox{\Hypertarget{affichage_8h_af6becf985f75737e7118d19a69ff27af}\label{affichage_8h_af6becf985f75737e7118d19a69ff27af}} 
\index{affichage.h@{affichage.h}!getWinInfo@{getWinInfo}}
\index{getWinInfo@{getWinInfo}!affichage.h@{affichage.h}}
\doxysubsubsection{\texorpdfstring{getWinInfo()}{getWinInfo()}}
{\footnotesize\ttfamily void get\+Win\+Info (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Window $\ast$}]{window,  }\item[{\mbox{\hyperlink{structmap__t}{map\+\_\+t}} $\ast$}]{map,  }\item[{SDL\+\_\+\+Rect $\ast$}]{view,  }\item[{int $\ast$}]{width,  }\item[{int $\ast$}]{height,  }\item[{int $\ast$}]{dst\+Coef,  }\item[{int $\ast$}]{x\+Border,  }\item[{int $\ast$}]{y\+Border }\end{DoxyParamCaption})}
...
{\em dst\+Coef} & Coeficient qui permet d\textquotesingle{}apdater l\textquotesingle{}affichage de sorties à plusieur dimensions \\
\hline
{\em x\+Border} & Bordure à gauche dans la fenêtre \\
\hline
{\em y\+Border} & Bordure en haut dans la fenêtre \\
\hline
\end{DoxyParams}
